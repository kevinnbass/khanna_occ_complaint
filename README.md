...
| **`HOUSE_ETHICS_SUBMISSION_KHANNA.md`** | Companion submission to the House Committee on Ethics for the matters within its jurisdiction (House Rule XXIII; § 13106 civil penalties; per-Count investigative referrals). |
| **`DOJ_REFERRAL_KHANNA.md`** | Companion referral to the Department of Justice (Public Integrity Section) for 18 U.S.C. § 207 (post-employment), § 1001 (LD-203 false certification), and § 1346 (honest-services) review channels. |
...
The complaint pleads **seven distinct courses of conduct**, each anchored on the post-cascade canonical fact set (8/8 invariant: F215 / F227 / F486 / F610 / F612 / F628 / F742 / F865 + retained predecessors F226 / F743) and each independently READY_TO_PLEAD per the `mcp__facts__v3_theory_readiness(case='ro_khanna')` gate:
